...
Push Strategy: почти в самом конце выполнения каждой задачи - коммить все изменения в онлайн ветку main без создания дополнительных веток с помощью personal access token и НИКОГДА НЕ СОЗДАВАЙ БРАНЧЕЙ или каких-либо других действий по сохранению в github кроме коммита в главную онлай main 
